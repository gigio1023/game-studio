...
- `foundations/game-design-foundations.md`: design lenses, MDA, meaningful play, playcentric iteration.
- `foundations/game-production-and-direction.md`: production stages, milestones, public demo, release work.
- `foundations/narrative-and-scenario-design.md`: story, scenario, dialogue, content scope, narrative AI.

...
[Game Craft Source Map](../../core/references/game-craft-source-map.md) but
go further: they survey live practice, contrarian voices, and adjacent
agentic-AI work that the source map does not yet cover.
...
sources and surfaced critical perspectives. Round 4 expanded the research
surface into studio operation, beginner pedagogy, player operations,
...
| [Additional Canon](textbook-canon/01-additional-canon.md) | Foundational texts the source map currently misses, with framework-gap mapping. |
...
| [Agentic Co-Creation](round4-ai-co-creation/01-agentic-co-creation.md) | AI-assisted game development, agent skills, engine assistants, and craft-coaching differentiation. |
...
| [Positioning And Market Gap](round5-positioning/01-positioning-and-market-gap.md) | Comparator map and product positioning: proof-gated craft coach with production rails. |
...
| [Round 4-5 Synthesis](round4-5-synthesis.md) | Later synthesis covering craft-coach positioning, pedagogy, player operations, anti-slop quality, and implementation priorities. |
...
Research-grounded improvements are written up in the value-review plan:
[Research-Grounded Improvements](../../docs/improvement/value-review/15-research-grounded-improvements.md)
and [Craft Coach Positioning](../../docs/improvement/value-review/16-craft-coach-positioning.md).
...
- Each round informed the next: Round 2 deepened Round 1 surfacings, Round 3
  verified and critiqued Rounds 1-2, Round 4 expanded the search surface, and

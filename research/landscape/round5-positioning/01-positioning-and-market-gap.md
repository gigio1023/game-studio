...
The unowned gap is **craft judgment under too much generated material**.
...
This gap is not best described as "curriculum." Curriculum teaches people. Game Studio should teach, but the live need is a system that **helps review decisions while work is being made**.

This gap is not best described as "production framework" either. That phrase is too broad and pulls Game Studio into competition with BMAD, Linear-style project systems, engine task manifests, and coding-agent command centers. Game Studio needs milestone contracts, but only where they serve playable validation.
...
**Best position: Game Studio is an AI-assisted game production framework for AI-assisted game development.**

The practical product shape is a hybrid:

- **Taste-to-prototype guidance as the front door.** It helps a creator see their game more clearly, make better taste decisions, and avoid mistaking AI output for design quality.
- **Production framework as the spine.** Gates, evidence, role reviews, decision records, and proof budgets keep the coaching attached to real artifacts.
...
**Game Studio helps humans turn AI-assisted game ideas into playable builds and validation notes, craft critique, scope decisions, and responsible production steps.**

That position is defensible because it avoids competing directly with engines, generators, schools, or agent platforms. It also matches the repo's strongest existing ideas: human authority, playable validation, role-led review, evidence gates, production judgment, and anti-slop quality pressure.
...
**Dangerous: "game design curriculum."** Too passive and too crowded. Books, courses, universities, mentorship programs, YouTube, Discords, and communities already serve this. Game Studio's advantage is not lesson delivery; it is review support inside the project.
...
**Dangerous: "AI co-designer with taste."** Round 4's critique argues against anthropomorphic creative authority. The safer language is coach, reviewer, scaffold, and validation workflow. The human owns taste, public claims, and continuation.
...
- "from taste to first playable"
- "build less, validate sooner"
...
> Game Studio is an AI-assisted game production framework for AI-assisted game development. It helps creators turn ideas, AI output, and prototypes into playable validation, role-led critique, scope decisions, and responsible production steps while keeping human taste and public claims under human control.

Shorter version:

> Not a game generator: a taste-to-prototype workflow that turns AI output into playable builds and validation notes, reviews, gates, and human decisions.

## Repo Implications

1. **Make game design review workflow the public category.** The README and product boundary should foreground game design review workflow and milestone-gated playable validation, not "studio command center," "curriculum," or "skill registry."
...
3. **Treat skills as enforceable review protocols.** Every role skill should require inspected artifact, authority source, observed/inferred/taste split, verdict, missing proof, next smallest proof, human-only decision, and stop condition.
...
9. **Avoid building a broad registry before the core review loop is sharp.** A skill registry becomes valuable only after the role contracts are strong enough that third-party skills cannot dilute the milestone-gated playable validation craft standard.

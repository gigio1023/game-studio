...
- **Comprehension evidence**: The player understands goal, affordance, state, risk, and feedback.
- **Feel evidence**: Input, camera, animation, visual response, and audio response support the verb.
- **Accessibility evidence**: The core path has reviewed barriers or honest limitations.
- **Release evidence**: Public claims map to build behavior or are removed.

...
**Goal:** Evolve Game Studio into a repo-local system for discovery-driven, proof-gated AI game production.

**Architecture:** Keep `core/` as the stable creative-production substrate; put engine, genre, release, and runtime specificity into profiles, packs, and adapters; keep player-facing judgment in playable proofs and role-led review.
...
| [04-adapters-install-contribution.md](04-adapters-install-contribution.md) | Adapter hooks, install/upgrade surfaces, manifest checks, and contributor-only hygiene. |
| [05-readme-public-surface.md](05-readme-public-surface.md) | README, diagrams, public visual surface, and OSS reference patterns from major repositories. |
...
direction or a player's taste profile into playable proofs, then uses review
and gates to move toward a finishable game.

Public language should use `proof`, `playable proof`, `proof-gated`, and
...
- evidence standards
- source-backed game craft methods
...
- a promise that one prompt can generate a finished game without playable proof
...
They should not dominate `README.md`, user-facing onboarding, or Game Studio's definition of readiness. The main user-facing story is playable proof, role-led review, gate verdicts, and claim-to-proof mapping.
...
5. Adapter/install/contribution surfaces.
6. README and public visual surface.

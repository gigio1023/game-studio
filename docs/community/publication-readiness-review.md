...
| --- | --- |
| [GitHub Open Source Guides](https://opensource.guide/starting-a-project/) | Root README, license, contributing guide, and code of conduct as explicit community channels. |
| [GitHub Community Standards](https://github.com/github/opensource.guide/community) | Public profile areas: README, code of conduct, contributing, license, security policy, issue templates, and pull request template. |
...
| [OpenSSF Scorecard](https://github.com/ossf/scorecard) | Treat security and repository health as explicit project files. |

...
| Page | Use |
| --- | --- |
| [Distribution Preparation](distribution/README.md) | Prepare plugin-first packaging, marketplace submission, update policy, and rollout. |

## Improvement Plans

| Plan | Use |
| --- | --- |
| [Improvement Index](improvement/README.md) | Find active plans for improving Game Studio itself. |
| [Value Review Improvement Plan](improvement/value-review/README.md) | Improve product value, skill routing, examples, role review, validation artifacts, and adapters. |

## Community Review

| Page | Use |
| --- | --- |
| [Publication Readiness Review](community/publication-readiness-review.md) | Review public release readiness for docs. |
| [Visual Readiness Review](community/visual-readiness-review.md) | Review diagram and visual asset quality. |
